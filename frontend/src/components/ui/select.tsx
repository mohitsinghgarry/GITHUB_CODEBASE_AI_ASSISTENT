...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      'py-1.5 pl-8 pr-2 text-label-sm text-on-surface-variant uppercase tracking-widest',
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'py-1.5 pl-8 pr-2 text-body-md',
      'outline-none',
      'focus:bg-surface-container-highest focus:text-on-surface',
