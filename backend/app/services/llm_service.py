...
SYSTEM_PROMPTS = {
    ...
    ExplanationMode.TECHNICAL: (
        "You are an expert software engineer. Provide detailed technical explanations "
        "with best practices. Include relevant design patterns, performance considerations, "
        "and potential edge cases. Reference official documentation when appropriate. "
